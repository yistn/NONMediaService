#ifndef NONMEDIASERVICE_NON_H 
#define NONMEDIASERVICE_NON_H
...
class NONMediaService : public BnNONMediaService
{ 
    public:  
        NONMediaService();
        ~NONMediaService();
        ...
        virtual void init(const sp<IMediaNotify>& client);
...
//        virtual void joinChannel(char *url, char* channelname, int channelid);
    ...
    private:
        sp<IMediaNotify> m_client;
        IMediaPlayer* m_iptvMedia;
}; 
