#ifndef IMEDIAPLAYER_NON_H 
#define IMEDIAPLAYER_NON_H
 ...
 ***********************************************/  
class NONMediaService;
class IMediaPlayer {
    public:
        //static void instantiate();  
        IMediaPlayer(NONMediaService *service);
        virtual ~IMediaPlayer();
        static IMediaPlayer* create(NONMediaService *service);
